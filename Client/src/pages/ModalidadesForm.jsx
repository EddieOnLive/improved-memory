...
import { crearModalidadesRequest, getModalidadesRequest, getModalidadesRequestUna, updateModalidadesRequest } from "../api/modalidades.api";
...
function ModalidadesForm() {
  ...
  return (
    <>
      <div className="bg-slate-300 cont w-50 rounded-md p-4 m x-auto mt-10 flex flex-col columns-1 items-center">
        <h1 className="text-5xl font-bold text-center py-3 text-black">
          Nueva Modalidad
        </h1>
        <Formik
